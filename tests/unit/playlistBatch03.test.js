...
const BATCH = [
  { sessionId: '03A', videoId: 'Ijg4E9LhOdw', title: '第3講 略述集量論的禮讚文（上）' },
  { sessionId: '03B', videoId: 'N0T2AfsrbaE', title: '第3講 略述集量論的禮讚文（下）' },
];

test('M4 batch-03 registers session 03A and 03B in course and catalog', () => {
...
test('M4 batch-03 session JSONs carry timestamped transcript and question index', () => {
  for (const item of BATCH) {
...
test('M4 batch-03 audio map records youtube provenance without claiming a local proxy', () => {
...
test('M4 batch-03 toc indexes batch questions per session', () => {
