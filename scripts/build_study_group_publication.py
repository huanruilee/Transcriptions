...
def build_session(index: int) -> tuple[dict, dict]:
    ...
    session = {
        ...
        "sourceOutlineId": "32-08" if index in (14, 15) else ("32-09" if index in (16, 17) else ("32-10" if index in (18, 19) else ("32-11" if index in (20, 21) else ("32-28" if index in (22, 23) else ("32-13" if index in (24, 25) else ("32-14" if index in (26, 27) else ("32-15" if index in (28, 29) else ("32-16" if index in (30, 31) else None))))))))),
        "title": source["title"],
